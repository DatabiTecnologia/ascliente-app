...
st.set_page_config(page_title="Financeiro", layout="centered", initial_sidebar_state="collapsed")
st.markdown("""
    <style>
...
if 'usuario_logado' not in st.session_state or st.session_state['usuario_logado']['tipo'] != 'financeiro':
